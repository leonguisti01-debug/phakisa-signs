        ...
        <div className="flex flex-col gap-10 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-4 text-4xl font-black leading-tight md:text-6xl">
              COMPLETE SIGNAGE &
              <br />
              <span className="text-[#00A651]">SHOPFITTING</span> SOLUTIONS
            </h2>

            <p className="mt-6 text-lg leading-8 text-gray-600">
              From bold branding to complete retail transformations, we deliver
              quality workmanship, innovative solutions and exceptional
              service.
            </p>
          </div>
            ...
            return (
              ...
              >
                ...
                <div className="relative p-8">
                  ...
                  <span className="mt-8 inline-block font-bold text-[#00A651] transition group-hover:translate-x-2">
                    LEARN MORE →
                  </span>
                </div>
              </Link>
