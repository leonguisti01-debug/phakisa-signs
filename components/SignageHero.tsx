...
export default function SignageHero() {
  return (
    <section className="relative overflow-hidden bg-[#08141B] pt-40 pb-24">
      ...
      {/* Watermark */}
      <div className="pointer-events-none absolute left-0 top-1/2 -translate-y-1/2 text-[20rem] md:text-[26rem] font-black leading-none text-white/[0.03]">
        SIGN
      </div>
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-10">
        ...
        >
          ...
          <p className="mt-8 max-w-2xl text-xl leading-9 text-gray-300">
            Eye-catching indoor and outdoor signage designed to strengthen your
            brand, attract customers and make your business impossible to miss.
          </p>
